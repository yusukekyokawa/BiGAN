...
for epoch in range(0, EPOCH):
    ...
    for i in range(0, len_data, BATCH_SIZE):
        ...
        merged_ = sess.run(merged,
                           feed_dict={z_: z, x_: img_batch, d_dis_f_: tar_g_0, d_dis_r_: tar_g_1, is_training_: False})
    ...
    print("----------------------------------------------------------------------")
    print(
        "epoch = {:}, Encoder Total Loss = {:.4f}, Decoder Total Loss = {:.4f}, Discriminator Total Loss = {:.4f}".format(
    ...
    if epoch % VALID_SPAN == 0:
        ...
        print(
            "tp:{}, fp:{}, tn:{}, fn:{}, precision:{:.4f}, recall:{:.4f}, AUC:{:.4f}".format(tp, fp, tn, fn, precision,
                                                                                             recall, auc))
        log_list.append([epoch, auc])
